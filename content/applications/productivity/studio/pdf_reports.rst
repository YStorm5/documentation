...
- :guilabel:`Font`: Seven fonts are available: Lato, Roboto, Open Sans, Montserrat, Oswald, Raleway,
  and Tajawal (which supports Arabic and Latin scripts). Go to
  `Google Fonts <https://fonts.google.com/>`_ to preview them.
...
.. important::
   It is strongly recommended to **duplicate** the standard report and preform changes in the
...
.. spoiler:: Conditional blocks
   ...
   attribute. As an example, let's show a quick message explaining that there are no tags on
   the quotation:
